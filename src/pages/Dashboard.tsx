...
export const Dashboard = () => {
  ...
  const { articles, loading, refreshing, sourceScores, refreshArticles, toggleFavorite, toggleRead, deleteArticle, banDomain, purgeRead } = useArticles();
